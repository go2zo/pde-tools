 ...
 * <ul>
 *   <li>{@link net.jeeeyul.pdetools.model.pdetools.impl.ShellInfoImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link net.jeeeyul.pdetools.model.pdetools.impl.ShellInfoImpl#getShellStyle <em>Shell Style</em>}</li>
 *   <li>{@link net.jeeeyul.pdetools.model.pdetools.impl.ShellInfoImpl#getShellTitle <em>Shell Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ShellInfoImpl extends MinimalEObjectImpl.Container implements ShellInfo {
	...
	protected EClass eStaticClass() {
		return PdetoolsPackage.Literals.SHELL_INFO;
	}
	...
	public void setIcon(ImageData newIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PdetoolsPackage.SHELL_INFO__ICON, oldIcon, icon));
	}
	...
	public void setShellStyle(int newShellStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PdetoolsPackage.SHELL_INFO__SHELL_STYLE,
					oldShellStyle, shellStyle));
	}
	...
	public void setShellTitle(String newShellTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PdetoolsPackage.SHELL_INFO__SHELL_TITLE,
					oldShellTitle, shellTitle));
	}
